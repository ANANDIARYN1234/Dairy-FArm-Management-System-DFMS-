<?php
// admin/sales/payment-add.php - CORRECT VERSION WITH ADVANCE PAYMENT
session_start();
...
if ($sale['balance'] <= 0) {
    ...
    header("Location: sales-view.php?id=" . $sale_id);
    exit();
}
    ...
    <div class="page-header">
        <div class="header-content">
            ...
            <div class="breadcrumb">
                ...
                <span>/</span>
                <a href="sales-view.php?id=<?php echo $sale_id; ?>">Sale <?php echo $sale_id; ?></a>
                <span>/</span>
                <span>Add Payment</span>
            </div>
        </div>
        <div class="header-actions">
            <a href="sales-view.php?id=<?php echo $sale_id; ?>" class="btn btn-secondary">Back to Sale</a>
        </div>
    </div>
            ...
            <div class="card-body" style="padding: 1.5rem;">
                <form method="POST" action="" id="paymentForm">
                    ...
                    <div class="form-actions" style="margin-top: 1.5rem; justify-content: flex-end;">
                        <a href="sales-view.php?id=<?php echo $sale_id; ?>" class="btn btn-secondary">Cancel</a>
