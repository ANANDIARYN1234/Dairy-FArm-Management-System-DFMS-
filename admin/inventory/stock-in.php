...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Insert transaction (trigger will update inventory automatically)
    if (empty($errors)) {
        ...
        if ($trans_stmt->execute()) {
            ...
            $errors[] = "Failed to add stock: " . $conn->error;
        }
        $trans_stmt->close();
    }
}
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea name="remarks" class="form-control" rows="2" 
                                      placeholder="Optional notes (e.g., supplier, invoice number)"></textarea>
                        </div>
                    </div>

                    <div class="info-box" style="margin-top: 1.5rem;">
                        <strong>ℹ Note:</strong> New stock: <strong><?php echo number_format($item['current_quantity'], 2); ?> + [Your Quantity] <?php echo $item['unit']; ?></strong>
                    </div>
